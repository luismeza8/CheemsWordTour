...
android {
    namespace = "com.example.cheemswordtour"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.cheemswordtour"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.squareup.retrofit2:converter-gson:2.9.0") //Implementa la conversion de Json a Gson
